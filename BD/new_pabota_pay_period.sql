...
CREATE TABLE `pay_period` (
  `id_pay_period` int NOT NULL AUTO_INCREMENT,
  `name_period` varchar(45) DEFAULT NULL,
  `begining_period` date DEFAULT NULL,
  `ending_period` date DEFAULT NULL,
  PRIMARY KEY (`id_pay_period`)
...
INSERT INTO `pay_period` VALUES (1,'ОПП','2024-12-12','2025-11-11'),(2,'ОЗЗ','2024-12-12','2025-11-11'),(3,'ВВИ','2024-11-11','2025-11-11');
