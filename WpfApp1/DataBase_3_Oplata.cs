...
namespace WpfApp1
{
    class DataBase_3_Oplata
    {
        ...
        public int AddUser(int idd, string name)
        {
            ...
            connection.Open();
            string cndText = "INSERT INTO new_pabota.pay(id, name)" +
                $"VALUES ('{idd}','{name}');";
        ...
        public void ChangeUser(string name, int id)
        {
            ...
            string cndText = $"UPDATE new_pabota.pay SET `name` = '{name}' WHERE `id` = '{id}';";
        ...
        public void RemoveDataBese(int id)
        {
            ...
            {
                string sql = "DELETE FROM new_pabota.pay WHERE (`id` =@id)";
                connection.Open();
        ...
        public DataTable GetTable()
        {
            ...
            MySqlDataAdapter sqlDa = new MySqlDataAdapter("SELECT * FROM new_pabota.pay LEFT JOIN SELECT * FROM new_pabota.pay_period", connection);
